...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"Images_GUI\bg-reg.png")
        bg1=bg1.resize((1200,520),PIL.Image.Resampling.LANCZOS)
        ...
        #title section
        title_lb1 = Label(bg_img,text="PTIT - Chức năng nhận diện gương mặt",font=("verdana",20,"bold"),bg="navyblue",fg="white")
        ...
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                if confidence > 77:
                    ...
                    cv2.putText(img,f"MSV:{r}",(x,y-30),cv2.FONT_HERSHEY_COMPLEX,0.8,(64,15,223),2)
